...
def main():
    ...
    # Room mix
    room = df["Room_Type"].value_counts(normalize=True).mul(100).round(1).reset_index()
    room.columns = ["room_type", "pct"]
    ...
    data = {
        ...
        "room_mix": room.to_dict(orient="records"),
        "pareto": pareto,
